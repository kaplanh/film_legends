...
[:point_right: Click here to see on browser](https://film-legends.vercel.app/)

![NBA Legends](./src/assets/film-legends.gif)
...
-   Parent Component icinde json datayi filter() & map() leme
    ...
    filteredData.map((player, i) => <FilmCard key={i} {...player} />);
...
-   Css Animation rotate & translate;
    ...
    .header {
        ...
        & h1 {
            font-family: fantasy;
            animation: h1-translate infinite 5s alternate;
        }
    }
